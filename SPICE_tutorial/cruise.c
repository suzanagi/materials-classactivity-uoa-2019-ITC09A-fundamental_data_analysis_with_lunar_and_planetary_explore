...
int main(int argc, char *argv[]) {
  ...
  for(et=start_et;et< start_et+24*3600*857-3600;et=et+3600){
    ...
    spkpos_c ( "MUSES-C", et, "J2000", "NONE", "SUN", hayabusa_pos_J2k, &lt_hayabusa);
    spkpos_c ( "ITOKAWA", et, "J2000", "NONE", "SUN", itokawa_pos_J2k, &lt_itokawa);
    spkpos_c ( "EARTH", et, "J2000", "NONE", "SUN", earth_pos_J2k, &lt_earth);
